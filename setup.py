...
"""
Installation no longer worked with the ./setup/setup.py filez, see
https://stackoverflow.com/questions/72715462/how-to-install-this-python-package-from-sources
